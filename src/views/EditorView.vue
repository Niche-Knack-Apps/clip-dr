...
<template>
  <div class="h-full flex flex-col p-3 gap-2 overflow-hidden relative">
    <!-- Project loading overlay — instant show, fade on dismiss -->
    <div
      v-if="projectStore.loading"
      class="absolute inset-0 z-50 flex items-center justify-center bg-gray-900 rounded-lg"
    >
      <div class="flex flex-col items-center gap-3">
        <svg class="w-8 h-8 animate-spin text-cyan-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
          <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
        </svg>
        <span class="text-sm text-gray-400 font-medium">Loading project...</span>
      </div>
    </div>
    ...
    >
      <div
        class="w-96 mb-4 text-gray-400/40"
        style="filter: drop-shadow(0 1px 0 rgba(255,255,255,0.06)) drop-shadow(0 -1px 0 rgba(0,0,0,0.7)); mask-image: linear-gradient(to right, transparent 0%, black 15%, black 85%, transparent 100%); -webkit-mask-image: linear-gradient(to right, transparent 0%, black 15%, black 85%, transparent 100%)"
      >
